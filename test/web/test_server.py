...
class ServerTest(unittest.TestCase):
    ...
    def test_index(self):
        # given
        server = Server(self.__create_mock_light_service(), self.__create_mock_light_service(),
                        self.__create_mock_light_service(), self.__create_energymonitor_service())
    ...
    def test_kitchen_light_status(self):
        # given
        kitchen_light_service = self.__create_mock_light_service()
        kitchen_light_service.status = MagicMock()
        server = Server(kitchen_light_service, self.__create_mock_light_service(), self.__create_mock_light_service(),
                        self.__create_energymonitor_service())
    ...
    def test_energymonitor_status(self):
        ...
        server = Server(self.__create_mock_light_service(), self.__create_mock_light_service(),
                        self.__create_mock_light_service(), energymonitor_service)
    ...
    def test_energy_monitor_start(self):
        ...
        server = Server(self.__create_mock_light_service(), self.__create_mock_light_service(),
                        self.__create_mock_light_service(), energy_monitor_service)
    ...
    def __create_mock_light_service(self):
